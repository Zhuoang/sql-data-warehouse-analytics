...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM '/var/opt/mssql/import/source_crm/erp_cust_az12.csv'
        WITH (
            FIELDTERMINATOR = ',',
            FIRSTROW        = 2,
            TABLOCK
        ...
        FROM '/var/opt/mssql/import/source_crm/erp_loc_a101.csv'
        WITH (
            FIELDTERMINATOR = ',',
            FIRSTROW        = 2,
            TABLOCK
        ...
        FROM '/var/opt/mssql/import/source_crm/erp_px_cat_g1v2.csv'
        WITH (
            FIELDTERMINATOR = ',',
            FIRSTROW        = 2,
            TABLOCK
